...
- the `href` attribute of the `link` tag when the `rel` attribute contains `stylesheet`, `alternate stylesheet`, `icon`, `shortcut icon`, `mask-icon`, `apple-touch-icon`, `apple-touch-icon-precomposed`, `apple-touch-startup-image`
